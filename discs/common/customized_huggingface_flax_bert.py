...
class FlaxBertEmbeddings(nn.Module):
    ...
    def __call__(self, input_ids, infill_one_hots, infill_pos, token_type_ids, position_ids, attention_mask, deterministic: bool = True):
        """ Customized to accomodate infilling"""
        # Embed
        inputs_embeds = self.word_embeddings(input_ids.astype("i4")) ### B * L * 768 for bert base, word embedding: 30522 * 768
...
class FlaxBertPreTrainedModel(FlaxPreTrainedModel):
    ...
    def init_weights(self, rng: jax.random.PRNGKey, input_shape: Tuple) -> FrozenDict:
        ...
        return self.module.init(rngs, input_ids, infill_one_hots, infill_pos, attention_mask, token_type_ids, position_ids, return_dict=False)[
            "params"
        ]
...
class FlaxBertModule(nn.Module):
    ...
    def __call__(
        ...
        hidden_states = self.embeddings(
            input_ids, infill_one_hots, infill_pos, token_type_ids, position_ids, attention_mask, deterministic=deterministic
        )
