...
import discs.models.bernoulli as bernoulli_model
...
import discs.samplers.locallybalanced as locallybalanced_sampler
import discs.samplers.gibbswithgrad as gibbswithgrad_sampler
import discs.evaluation.evaluator as metric_evaluator
import os
...
def get_model(config_main, config_model):
  if config_main.model == 'bernoulli':
    return bernoulli_model.Bernoulli(config_model)
